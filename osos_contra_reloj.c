...
/*
* Pre: Que el párametro jugada sea una jugada de movimiento válida (W,A,S,D)
...
*      -> Que el parámetro tope_elementos > 0.
...
* Post: Retornará true si el parámetro posicion no coincide con la posicion de un (personaje, chloe, ó algún elemento previamente cargado) o false en caso contrario.
*/
...
/*
* Pre: -> Que el parámetro tipo sea un (Árbol (A), Piedra (R), Koala (K), Vela (V), Bengala (E), Pila (B)).
*      -> Que el parámetro tope_elementos sea > 0.
*      -> Que el parámetro elemento sea válido (fil >= MIN_FIL_BOSQUE Y fil < MAX_FIL_BOSQUE ) y (col >= MIN_COL_BOSQUE Y col < MAX_COL_BOSQUE).
* Post: Agregará un elemento al vector de structs pasado por parámetro (elementos_mapa), con sus respectivos campos cargados.
*/
...
*      -> Que los parámetros fil y col sean (fil >= MIN_FIL_BOSQUE Y fil < MAX_FIL_BOSQUE ) y (col >= MIN_COL_BOSQUE Y col < MAX_COL_BOSQUE).
...
*      -> Que el parámetro personaje sea (fil >= MIN_FIL_BOSQUE Y fil < MAX_FIL_BOSQUE ) y (col >= MIN_COL_BOSQUE Y col < MAX_COL_BOSQUE).
...
/*
* Pre: -> Que el parámetro personaje sea (fil >= MIN_FIL_BOSQUE Y fil < MAX_FIL_BOSQUE ) y (col >= MIN_COL_BOSQUE Y col < MAX_COL_BOSQUE).
*      -> Que la jugada_movimiento sea una jugada de movimiento válida (W,A,S,D).
...
*      -> Que el parámetro posición_a_eliminar, coincida con la posición de un elemento de la mochila del personaje o de las herramientas.
*      -> Que el parámetro tipo_elemento sea un elemento válido (Mochila (M), Mapa(X)).
* Post: Eliminará una herramienta de la mochila del personaje (Bengala (E), Vela (V)) ó en caso contrario del bosque (Pila(B), Bengala (E), Vela (V)).
*/
...
/*
* Pre: -> Que el parámetro tope_herramientas sea > 0
*      -> Que el parámetro personaje sea (fil >= MIN_FIL_BOSQUE Y fil < MAX_FIL_BOSQUE ) y (col >= MIN_COL_BOSQUE Y col < MAX_COL_BOSQUE).
...
/*
* Pre: -> Que el parámetro mochila venga correctamente cargado con sus herramientas de tipo (Vela (V), Bengala (E), Linterna (L)).
* Post: Descontará la cantidad de movimientos a la herramienta de la mochila que esté en uso.
*/
...
* Post: Encenderá la linterna, vela o bengala, según sea el contenido del parámetro jugada_encendido, dejando iluminado a los elementos del bosque
*       de tipo (Árbol (A), Piedra (R), Koala (K), Pila (B), Bengala (E), Vela (V)). En caso de que esten dentro del rango de iluminación.
*/
...
* Post: Encenderá la linterna, vela o bengala, según sea el contenido del parámetro jugada_encendido dejando iluminada a chloe, si esta dentro del rango de iluminación.
*/
